...
# ----- reasoning_module ----- 
from reasoning_llama import load_reasoning_module, module_generate, inference_alltype_batch, inference_alltype_batch_with_buffer
# reasoning_llm
from tune_Controller import RetrieveM


# ----- controller -----
def load_controller(exp_dir,model_name=None, retrieve_learning=False):
    # read config
    ...
    if retrieve_learning:
        model = RetrieveM(args, model_config)
        model.load_state_dict(state_dict)
        return model.controller_model_, tokenizer, args
    else:
...
def search_task1(data_item,reasoning_module_tuple,reasoning_module_abd_tuple, controller_tuple, show=False,
                 bleurt_scorer=None,
...
def run(args):
    ...
    controller,tokenizer_controller,args_controller = load_controller(args.exp_dir_controller, args.model_name_controller, args.retrieve_learning)
