...
for i in {1..5}
do
    exp_dir_controller=../exp/Controller_task1/retrieve_learning_v2/round_$i
    for iter in 438 876 1314 1752 2190;
    do
    CUDA_VISIBLE_DEVICES=$cuda_id python reasoning_task1_llm.py \
...
# round=1
# for iter in 2190 438 438 438 1314;
# do
# model_name_controller=model_$iter.pth
...
# --save_dir_name reproduce_task1_llm --save_details
# round=$((round+1))
# done
