...
# for i in {1..5}
# do
#     exp_dir_controller=../exp/Controller_task2/retrieve_learning_v5/round_$i
#     for iter in 438 876 1314 1752 2190;
#     do
#     CUDA_VISIBLE_DEVICES=$cuda_id python reasoning_task2.py \
...
round=1
for iter in 876 2190 438 2190 438;
do
model_name_controller=model_$iter.pth
exp_dir_controller=../exp/Controller_task2/retrieve_learning_v5/round_$round
beam_num=10
